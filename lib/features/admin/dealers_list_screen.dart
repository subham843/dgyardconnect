...
class AdminDealersListScreen extends StatelessWidget {
  const AdminDealersListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    if (!FirestoreService.isAvailable) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text('Dealers', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700, color: const Color(0xFF0F172A))),
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirestoreService.users().where('role', isEqualTo: 'dealer').snapshots(),
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(backgroundColor: AppColors.primary.withValues(alpha: 0.12), child: const Icon(Icons.store_rounded, color: AppColors.primary)),
