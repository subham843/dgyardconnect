...
class JobTypesScreen extends StatelessWidget {
      ...
      builder: (ctx) => Padding(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(id == null ? 'Add job type' : 'Edit job type', style: Theme.of(ctx).textTheme.titleLarge),
              ...
              FilledButton(
                onPressed: () async {
                  ...
                  if (id == null) {
                    await FirestoreService.jobTypes().add({'name': name});
                  } else {
                    await FirestoreService.jobTypes().doc(id).update({'name': name});
                  }
  ...
  Future<void> _delete(BuildContext context, String id) async {
    ...
    if (ok == true) await FirestoreService.jobTypes().doc(id).delete();
  }
}
